<div class="block" style="display:inline-block;">
    <h2 class='sdstitle_block'>{l s='Последние статьи' mod='smartbloghomelatestnews'}</h2>
        {*<h2 class='sdstitle_block'><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Последние статьи' mod='smartbloghomelatestnews'}</a></h2>*}
