        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
            <fieldset>
                ...
                <div class="required form-group">
                    ...
                    <input class="is_required validate form-control phone_mask" data-validate="isPhoneNumber" type="text" name="phone" id="phone" value="{$smarty.post.phone}" />
                </div>
                <div class="required form-group">
                    <label for="lastname" class="required">
                        {l s='Адрес'}
                    </label>
                    <input class="is_required validate form-control" data-validate="isAddress" type="text" name="address" id="address" value="{$smarty.post.address}" />
                </div>
                <div class="required form-group">
