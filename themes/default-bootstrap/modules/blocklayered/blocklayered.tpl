							...
							{else}
								{if $filter.filter_type == 0}
									...
									<div class="layered_slider_container">
										<p>от</p><div class="minCost-inp-wrap inp-wrap"><input type="text" id="minCost" class="form-control" value="{$filter.min|intval}" data-value="{$filter.min|intval}"/></div>
										<p>до</p><div class="maxCost-inp-wrap inp-wrap"><input type="text" id="maxCost" class="form-control" value="{$filter.max|intval}" data-value="{$filter.max|intval}"/></div><p>грн.</p>
